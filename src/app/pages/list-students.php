                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <?php foreach ($allStudents as $student): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900 <?php echo ($student["isActive"] ? "text-green-500" : "text-red-500"); ?>"><?php echo ($student["isActive"] ? "active" : "banned"); ?></td>
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex gap-2">
                                            <?php if($student["isActive"] == 0) { ?>
                                            <a href="../../process/users/activate-user.php?user_id=<?= $student["user_id"]; ?>" class="p-1 hover:text-blue-600">
                                            ...
                                            <?php if($student["isActive"] == 1) { ?>
                                            <a href="../../process/users/ban-user.php?user_id=<?= $student["user_id"]; ?>" class="p-1 hover:text-red-600">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="../../process/users/delete-user.php?user_id=<?= $student["user_id"]; ?>" class="p-1 hover:text-red-600">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
