...
<body class="bg-gray-100">
    ...
    <div class="flex flex-grow flex-col">
        ...
        <main class="flex-1 ml-0 lg:ml-64 p-4">
            <!-- Page Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Tags list Overview</h1>
                ...
                <div class="p-4 border-b border-gray-200">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div class="flex gap-2 text-xs">
                            <a href="../../process/tags/add-tag.php" class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 flex items-center gap-2">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <?php foreach ($allTags as $tag): ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900">#<?= $tag->__get("tag_id"); ?></td>
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900"><?= $tag->__get('tag_name'); ?></td>
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex gap-2">
                                            <a href="../../process/tags/delete-tag.php?tag_id=<?= $tag->__get("tag_id"); ?>" class="p-1 hover:text-red-600">
                                            ...
                                            <a href="../../process/tags/edit-tag.php?tag_id=<?= $tag->__get("tag_id"); ?>" class="p-1 hover:text-blue-600">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
