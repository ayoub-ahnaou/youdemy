                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <?php foreach ($allTags as $tag): ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900">#<?= $tag["tag_id"]; ?></td>
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900"><?= $tag["tag_name"]; ?></td>
                                    <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex gap-2">
                                            <a href="../../process/tags/delete-tag.php?tag_id=<?= $tag["tag_id"]; ?>" class="p-1 hover:text-red-600">
                                            ...
                                            <a href="../../process/tags/edit-tag.php?tag_id=<?= $tag["tag_id"]; ?>" class="p-1 hover:text-blue-600">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
